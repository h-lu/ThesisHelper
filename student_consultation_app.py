...
def generate_all_ai_content(task_description, start_date, end_date, title, student_name):
    ...
    {{
        "consultations": [
            {{
                "date": "2024-03-01",
                "student_info": "讨论了选题，倾向于研究AI教育应用。",
                "teacher_info": "建议聚焦具体应用场景，如个性化学习。"
            }},
            // ... 其他14次咨询 ...
            {{
                "date": "2024-06-15",
                "student_info": "完成了答辩准备，总结了主要观点。",
                "teacher_info": "提供了一些可能的问题和应对策略。"
            }}
        ],
        "work_summary": "该生在毕业论文研究过程中表现出色。论文主要探讨了AI在教育领域的应用，采用了文献综述和实证研究相结合的方法。研究发现AI能显著提升个性化学习效果。该生工作态度认真，能独立思考，善于解决问题。建议进一步深化对AI教育应用的长期效果分析。",
        "mid_term_review": "学生前期工作扎实，文献综述全面，研究方法设计合理。建议后期加强数据分析深度，突出研究创新点，注意论文结构的逻辑性。"
    }}
    """
